...
public class FavoritesViewModel extends AndroidViewModel {
	...
	private LiveData<HeadLines> favoritesLiveData;
	...
	public FavoritesViewModel(@NonNull Application application) {
		...
		this.favoritesLiveData = articleRepository.getFavoritesHeadlines();
	}

	public LiveData<HeadLines> getFavoritesLiveData() {
